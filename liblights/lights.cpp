 ...
 * Revision 3.00 2015/11/04 DerFetzer
 * adapt to CM12.1 on Haierpad 1043
 *
 * ...................
 * ********************************************************************/
...
struct hw_module_t HAL_MODULE_INFO_SYM = {
    ...
    name: "Lights module",
    author: "Rockchip customized by DerFetzer",
...
static int light_device_close(struct hw_device_t *dev) 
{
    ...
    ALOGV(">>> Enter light_device_close");
    if (ctx) free(ctx);
    return 0;
}
...
{
    int status = 0;
    ALOGV(">>> Enter light_device_open:%s\n",name);
